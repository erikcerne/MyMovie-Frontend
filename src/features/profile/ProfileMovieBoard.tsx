...
export const ProfileMovieBord = ({
  title,
  userMoviesDto,
}: {
  title: string;
  userMoviesDto: UserMoviesDto[];
}) => {
  ...
  return (
    <div className="w-[75%] mx-auto">
      <div className="mb-5 mt-[50px] flex items-center justify-between gap-4 px-4 sm:px-0">
