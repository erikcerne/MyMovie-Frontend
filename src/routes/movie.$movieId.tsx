...
function RouteComponent() {
  ...
  return (
    <>
      ...
      <div className="inline-flex w-fit items-center rounded-full bg-base-200 p-1.5 ml-80 mt-5 mb-5">
        <button
          type="button"
      ...
      {activeTab === "Similar Movies" && (
        <div className="flex flex-wrap gap-4 flex-col items-center justify-center p-4 md:flex-row">
